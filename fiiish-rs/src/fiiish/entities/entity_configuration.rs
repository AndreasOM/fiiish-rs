		...
		*/
		...
		self.add_config(
			(
				...
				EntityType::Pickup,
				(32.0, 32.0).into(),
				("coin_blue_%02d", 0, 1, 32, 25.0).into(),
			)
				.into(),
		);
		self.add_config(
			(
				...
				EntityType::Pickup,
				(32.0, 32.0).into(),
				("coin_green_%02d", 0, 1, 32, 25.0).into(),
			)
				.into(),
		);
		self.add_config(
